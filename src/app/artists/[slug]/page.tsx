        ...
        <div className="flex-shrink-0 flex flex-col items-start md:items-end gap-6 pt-8 md:pt-10">
          ...
          <div className="flex items-center gap-5">
            ...
            {artist.socials.twitter && (
              <a href={artist.socials.twitter} target="_blank" rel="noopener noreferrer" className="transition-opacity hover:opacity-40" style={{ color: "#1a1a1a" }} aria-label="Twitter / X">
